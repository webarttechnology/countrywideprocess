...
<head>
	...
	<link href="{{ asset('dashboard/plugins/select2/css/select2-bootstrap4.css') }}" rel="stylesheet" />
	<!-- loader-->
	...
	<div class="wrapper">
		...
		<div class="sidebar-wrapper" data-simplebar="true">
			...
			<ul class="metismenu" id="menu">
                ...
                <li>
					<a href="{{ url('simplify-package') }}">
						<div class="parent-icon"><i class="fa-solid fa-map-location-dot"></i>
						</div>
						<div class="menu-title">Simplify Package</div>
					</a>
				</li>
				<!-- <li>
					<a href="reports.php">
				...
				<nav class="navbar navbar-expand">
					...
					<div class="search-bar flex-grow-1">
						...
						<select class="form-select d-inline-block" style="width: 150px;position: relative;top: -2px;margin-right: -3px;height: 39px;">
							...
							<input type="text" class="form-control search-control" placeholder="Type to search..." style=" width: calc(100% - 154px); display: inline-block;"> <span class="position-absolute top-50 search-show translate-middle-y"><i class='bx bx-search'></i></span>
