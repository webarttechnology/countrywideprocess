<html lang="en">
    <head>
        ...
        <!--DataTables css-->
		<link rel="stylesheet" href="{{asset('front_style/assets/plugins/Datatable/css/dataTables.bootstrap4.css') }}">
		<link rel="stylesheet" href="{{asset('front_style/assets/plugins/Datatable/css/buttons.bootstrap4.min.css') }}">
			...
			<div class="main-wrapper">
				...
				<nav class="navbar navbar-expand-lg main-navbar">
					...
					<a class="header-brand" href="">
						<img src="{{ asset(Session::get('company_logo')) }}" class="header-brand-img" alt="Splite-Admin  logo">
					</a>
					...
					<ul class="navbar-nav navbar-right">
						...
						<li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg d-flex">
							 ...
							 <span><img src="{{ asset('uploads/SmallLogo1.png') }}" alt="profile-user" class="rounded-circle w-32 mr-2"></span> 
							</a>
