        ...
        <ul>
                ...
                <div class="rmenucontent float-end">
                    ...
                    <ul>
                        @foreach($service as $item)
                            <li><a href="{{ URL::to('services/'.$item->slug_value) }}">{{ $item->name }}</a></li>
                        @endforeach
            ...
            <li class="clearfix">
                ...
                <div class="rmenucontent float-end">
                    ...
                    <ul>
                        <li><a href="{{ URL::to('services/'.$efile->slug_value) }}">E-Mail</a></li>
                        <li><a href="{{ URL::to('services/'.$efile->slug_value) }}">E-Filing Portal</a></li>
                        <li><a href="{{ URL::to('services/'.$efile->slug_value) }}">Client-oriented Features</a></li>
            ...
            <li class="clearfix">
                ...
                <div class="rmenucontent float-end">
                    ...
                    <ul>
                        ...
                        <li><a href="{{ URL::to('blog/'.$item->slug_value)  }}">{{ $item -> name }}</a></li>
                        @endforeach
                    </ul>
                </div>
            </li>
