				    ...
				    <div class="row justify-content-center " >
					    ...
					    <div class="col-12">
						    <div class="card" style="style">
								...
								<div class="card-body">
                                <form class="form-horizontal"  action="{{ url('admin/price-level/update') }}" method='POST' onsubmit=" return valid(); " enctype="multipart/form-data" >
                                        @csrf
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-xs-6">
                                                <div class="form-group">
                                                    ...
                                                    <select type="text" name="priceitem_id" id="priceitem_id" class="form-control" onchange="getpricezone()" >
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-xs-6">
                                                <div class="form-group">
                                                    ...
                                                    <select type="text" name="pricezone_id" id="pricezone_id" class="form-control"  >
                                                        <option value="">Pleace Select A Price Item</option>
