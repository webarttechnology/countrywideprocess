				    ...
				    <div class="row justify-content-center " >
					    ...
					    <div class="col-12">
						    <div class="card" style="style">
								...
								<div class="card-body">
									<form class="form-horizontal"  action="{{ url('admin/price-zone/add') }}" method='POST' onsubmit=" return valid(); " enctype="multipart/form-data" >
                                        @csrf
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-xs-6">
                                                <div class="form-group">
                                                    <label>Item Zone Name<span style="color:red"> *</span></label>
