                        ...
                        <table id="customers2" class="table datatable">
                            <thead>
                                <tr>
                                    ...
                                    <th width="15%">Price zone</th>   
                                    <th width="15%">Pricing level</th> 
                                    <th width="15%">Pricing Amount</th>
                                    <th width="15%">page</th>                          
                                ...
                                <td style="color: black;">{{ $loop -> index + 1 }}</td>
                                    ...
                                    <td style="color: black;">{{ $item -> pricelevel == ''?'':$item -> pricelevel ->name }}</span></td>
                                    <td style="color: black;">{{ $item -> amount }}</span></td>
                                    <td style="color: black;">{{ $item -> page?$item->page:"-" }}</span></td>
                                    <td style="color: black;"><a
                                            href="{{ URL('admin/price/update/'.$item -> id) }}"><i
                                                class="fa fa-pencil-square" aria-hidden="true"></i></a> | <a
                                            href="{{ URL('admin/price/delete/'.$item -> id) }}"
