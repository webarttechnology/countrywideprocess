					    ...
					    <div class="col-12">
						    <div class="card" style="style">
									<div class="card-header">
                                        ...
                                        <div style="color:green; padding-left:10px " id="successmsg">{{ Session::get('successmsg') }}</div>
                                        <div style="color:red; padding-left:10px " id="errmsg">{{ Session::get('errmsg') }}</div>
									</div>
								<div class="card-body">
									<form class="form-horizontal"  action="{{ url('admin/services-master/add') }}" method='POST' onsubmit=" return valid(); " enctype="multipart/form-data" >
                                        @csrf
                                        <div class="row">
...
<script>
    ...
    function valid() {
            if ($("#name").val() == '') {
                ...
                $("#errmsg").html("Please Upload Logo!!");
                //$("#email").css("border-color", "red");
                return false;
            }else if ($("#title").val() == '') {
